...
9. **hook_generator.py** - ИИ-генератор виральных заголовков для хуков (OpenAI GPT-4o).
10. **tts_generator.py** - Генератор профессиональной озвучки на 29 языках (ElevenLabs API).
11. **video_upscale.py** - Профессиональный апскейлинг видео до 4K (Real-ESRGAN).
12. **comfy_bridge.py** - Мост для интеграции After Effects с API ComfyUI.
